...
<html lang="<?= Yii::$app->language ?>">
    <head>
		...
		<!-- CORE CSS -->
		<link href="yassets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
		
		<!-- THEME CSS -->
		<link href="yassets/css/essentials.css" rel="stylesheet" type="text/css" />
		<link href="yassets/css/layout.css" rel="stylesheet" type="text/css" />
		<link href="yassets/css/color_scheme/green.css" rel="stylesheet" type="text/css" id="color_scheme" />
        <?= Html::csrfMetaTags() ?>
        ...
        <div id="wrapper" class="clearfix">
            ...
            <header id="header">
                ...
                <span class="logo pull-left">
                    <img src="yassets/images/logo_light.png" alt="admin panel" height="35" />
                </span>
                    ...
                    <ul class="nav pull-right">
                        ...
                        <li class="dropdown pull-left">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <img class="user-avatar" alt="" src="yassets/images/noavatar.jpg" height="34" /> 
...
<?= $content ?>
        ...
        <!-- JAVASCRIPT FILES -->
        <script type="text/javascript">var plugin_path = 'yassets/plugins/';</script>
        <script type="text/javascript" src="yassets/plugins/jquery/jquery-2.1.4.min.js"></script>
        <script type="text/javascript" src="yassets/js/app.js"></script>

        <!-- PAGE LEVEL SCRIPT -->
      

        <!-- STYLESWITCHER - REMOVE -->
        <script async type="text/javascript" src="yassets/plugins/styleswitcher/styleswitcher.js"></script>
<?php $this->endBody() ?>
    </body>
</html>
<?php $this->endPage() ?>