...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body class="smoothscroll enable-animation">	
        ...
        <div id="wrapper">
            ...
            <div id="topBar" class="dark">
                <div class="container">
                    ...
                    <ul class="top-links list-inline">
                        ...
                        <li>
                            <a class="dropdown-toggle no-text-underline" data-toggle="dropdown" href="#"><img class="flag-lang" src="zassets/images/flags/us.png" width="16" height="11" alt="lang" /> ENGLISH</a>
                            <ul class="dropdown-langs dropdown-menu">
                                <li><a tabindex="-1" href="#"><img class="flag-lang" src="zassets/images/flags/us.png" width="16" height="11" alt="lang" /> ENGLISH</a></li>
                                <li class="divider"></li>
                                <li><a tabindex="-1" href="#"><img class="flag-lang" src="zassets/images/flags/de.png" width="16" height="11" alt="lang" /> GERMAN</a></li>
                                <li><a tabindex="-1" href="#"><img class="flag-lang" src="zassets/images/flags/ru.png" width="16" height="11" alt="lang" /> RUSSIAN</a></li>
                                <li><a tabindex="-1" href="#"><img class="flag-lang" src="zassets/images/flags/it.png" width="16" height="11" alt="lang" /> ITALIAN</a></li>
                            </ul>
                        </li>
                        <li>
                ...
                <header id="topNav">
                    <div class="container">
                            ...
                            <li class="quick-cart">
                                ...
                                <div class="quick-cart-box">
                                    ...
                                    <div class="quick-cart-wrapper">
                                        ...
                                        <a href="#"><!-- cart item -->
                                            <img src="zassets/images/demo/people/300x300/4-min.jpg" width="45" height="45" alt="" />
                                            <h6><span>2x</span> RED BAG WITH HUGE POCKETS</h6>
                                            <small>$37.21</small>
                                        </a><!-- /cart item -->

                                        <a href="#"><!-- cart item -->
                                            <img src="zassets/images/demo/people/300x300/5-min.jpg" width="45" height="45" alt="" />
                        ...
                        <a class="logo pull-left" href="index.html">
                            <img src="zassets/images/logo_dark.png" alt="" />
                        </a>
                                    ...
                                    <li class="dropdown active"><!-- HOME -->
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="dropdown active">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li class="active"><a href="index-shop-1.html">SHOP LAYOUT 1</a></li>
            ...
            <section class="featured-grid">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <img src="zassets/images/demo/shop/home/grid1.jpg" alt="" />
                        ...
                        <div class="col-sm-6">
                            <div class="relative">
                                <img src="zassets/images/demo/shop/home/man_cat.jpg" alt="" />
                            ...
                            <div class="relative">
                                <img src="zassets/images/demo/shop/home/woman_cat.jpg" alt="" />
                    ...
                    <div class="owl-carousel featured nomargin owl-padding-10" data-plugin-options='{"singleItem": false, "items": "4", "stopOnHover":false, "autoPlay":4000, "autoHeight": false, "navigation": true, "pagination": false}'>
                        ...
                        <div class="shop-item nomargin">
                            ...
                            <div class="thumbnail">
                                ...
                                <a class="shop-item-image" href="shop-single-left.html">
                                    <img class="img-responsive" src="zassets/images/demo/shop/products/300x450/p13.jpg" alt="shop first image" />
                                    <img class="img-responsive" src="zassets/images/demo/shop/products/300x450/p14.jpg" alt="shop hover image" />
                                </a>
                                <!-- /product image(s) -->
                            ...
                            <div class="thumbnail">
                                ...
                                <a class="shop-item-image" href="shop-single-left.html">
                                    ...
                                    <div class="owl-carousel owl-padding-0 nomargin" data-plugin-options='{"singleItem": true, "autoPlay": 3000, "navigation": false, "pagination": false, "transitionStyle":"fadeUp"}'>
                                        <img class="img-responsive" src="zassets/images/demo/shop/products/300x450/p5.jpg" alt="">
                                        <img class="img-responsive" src="zassets/images/demo/shop/products/300x450/p1.jpg" alt="">
                                    </div>
                                    <!-- /CAROUSEL -->
                                </a>
                                <!-- /product image(s) -->
                        ...
                        <div class="shop-item nomargin">
                            ...
                            <div class="thumbnail">
                                <!-- product image(s) -->
                                <a class="shop-item-image" href="shop-single-left.html">
                                    <img class="img-responsive" src="zassets/images/demo/shop/products/300x450/p2.jpg" alt="shop first image" />
                                    <img class="img-responsive" src="zassets/images/demo/shop/products/300x450/p12.jpg" alt="shop hover image" />
                                </a>
                                <!-- /product image(s) -->
                        ...
                        <div class="shop-item nomargin">
                            ...
                            <div class="thumbnail">
                                <!-- product image(s) -->
                                <a class="shop-item-image" href="shop-single-left.html">
                                    <img class="img-responsive" src="zassets/images/demo/shop/products/300x450/p8.jpg" alt="shop first image" />
                                </a>
                                <!-- /product image(s) -->
                            </div>
                        ...
                        <div class="shop-item nomargin">
                            ...
                            <div class="thumbnail">
                                <!-- product image(s) -->
                                <a class="shop-item-image" href="shop-single-left.html">
                                    <img class="img-responsive" src="zassets/images/demo/shop/products/300x450/p7.jpg" alt="shop first image" />
                                </a>
                                <!-- /product image(s) -->
                            </div>
                        ...
                        <div class="shop-item nomargin">
                            ...
                            <div class="thumbnail">
                                <!-- product image(s) -->
                                <a class="shop-item-image" href="shop-single-left.html">
                                    <img class="img-responsive" src="zassets/images/demo/shop/products/300x450/p6.jpg" alt="shop first image" />
                                    <img class="img-responsive" src="zassets/images/demo/shop/products/300x450/p14.jpg" alt="shop hover image" />
                                </a>
                                <!-- /product image(s) -->
                            </div>
                        ...
                        <div class="shop-item nomargin">
                            ...
                            <div class="thumbnail">
                                <!-- product image(s) -->
                                <a class="shop-item-image" href="shop-single-left.html">
                                    <img class="img-responsive" src="zassets/images/demo/shop/products/300x450/p11.jpg" alt="shop hover image" />
                                    <img class="img-responsive" src="zassets/images/demo/shop/products/300x450/p3.jpg" alt="shop first image" />
                                </a>
                                <!-- /product image(s) -->
                            </div>
                        ...
                        <li class="col-lg-2 col-sm-4">
                            ...
                            <div class="shop-item">
                                ...
                                <div class="thumbnail noborder nopadding">
                                    <!-- product image(s) -->
                                    <a class="shop-item-image" href="shop-single-left.html">
                                        <img class="img-responsive" src="zassets/images/demo/shop/home/products/noimg.jpg" alt="" />
                                    </a>
                                    <!-- /product image(s) -->
                        ...
                        <li class="col-lg-2 col-sm-4">
                            ...
                            <div class="shop-item">
                                ...
                                <div class="thumbnail noborder nopadding">
                                    <!-- product image(s) -->
                                    <a class="shop-item-image" href="shop-single-left.html">
                                        <img class="img-responsive" src="zassets/images/demo/shop/home/products/6.jpg" alt="" />
                                    </a>
                                    <!-- /product image(s) -->
                        ...
                        <li class="col-lg-2 col-sm-4">
                            ...
                            <div class="shop-item">
                                ...
                                <div class="thumbnail noborder nopadding">
                                    <!-- product image(s) -->
                                    <a class="shop-item-image" href="shop-single-left.html">
                                        <img class="img-responsive" src="zassets/images/demo/shop/home/products/7.jpg" alt="" />
                                    </a>
                                    <!-- /product image(s) -->
                        ...
                        <li class="col-lg-2 col-sm-4">
                            ...
                            <div class="shop-item">
                                ...
                                <div class="thumbnail noborder nopadding">
                                    <!-- product image(s) -->
                                    <a class="shop-item-image" href="shop-single-left.html">
                                        <img class="img-responsive" src="zassets/images/demo/shop/home/products/8.jpg" alt="" />
                                    </a>
                                    <!-- /product image(s) -->
                        ...
                        <li class="col-lg-2 col-sm-4">
                            ...
                            <div class="shop-item">
                                ...
                                <div class="thumbnail noborder nopadding">
                                    <!-- product image(s) -->
                                    <a class="shop-item-image" href="shop-single-left.html">
                                        <img class="img-responsive" src="zassets/images/demo/shop/home/products/9.jpg" alt="" />
                                    </a>
                                    <!-- /product image(s) -->
                        ...
                        <li class="col-lg-2 col-sm-4">
                            ...
                            <div class="shop-item">
                                ...
                                <div class="thumbnail noborder nopadding">
                                    <!-- product image(s) -->
                                    <a class="shop-item-image" href="shop-single-left.html">
                                        <img class="img-responsive" src="zassets/images/demo/shop/home/products/10.jpg" alt="" />
                                    </a>
                                    <!-- /product image(s) -->
                        ...
                        <li class="col-lg-2 col-sm-4">
                            ...
                            <div class="shop-item">
                                ...
                                <div class="thumbnail noborder nopadding">
                                    <!-- product image(s) -->
                                    <a class="shop-item-image" href="shop-single-left.html">
                                        <img class="img-responsive" src="zassets/images/demo/shop/home/products/11.jpg" alt="" />
                                    </a>
                                    <!-- /product image(s) -->
                        ...
                        <li class="col-lg-2 col-sm-4">
                            ...
                            <div class="shop-item">
                                ...
                                <div class="thumbnail noborder nopadding">
                                    <!-- product image(s) -->
                                    <a class="shop-item-image" href="shop-single-left.html">
                                        <img class="img-responsive" src="zassets/images/demo/shop/home/products/1.jpg" alt="" />
                                    </a>
                                    <!-- /product image(s) -->
                        ...
                        <li class="col-lg-2 col-sm-4">
                            ...
                            <div class="shop-item">
                                ...
                                <div class="thumbnail noborder nopadding">
                                    <!-- product image(s) -->
                                    <a class="shop-item-image" href="shop-single-left.html">
                                        <img class="img-responsive" src="zassets/images/demo/shop/home/products/2.jpg" alt="" />
                                    </a>
                                    <!-- /product image(s) -->
                        ...
                        <li class="col-lg-2 col-sm-4">
                            ...
                            <div class="shop-item">
                                ...
                                <div class="thumbnail noborder nopadding">
                                    <!-- product image(s) -->
                                    <a class="shop-item-image" href="shop-single-left.html">
                                        <img class="img-responsive" src="zassets/images/demo/shop/home/products/3.jpg" alt="" />
                                    </a>
                                    <!-- /product image(s) -->
                        ...
                        <li class="col-lg-2 col-sm-4">
                            ...
                            <div class="shop-item">
                                ...
                                <div class="thumbnail noborder nopadding">
                                    <!-- product image(s) -->
                                    <a class="shop-item-image" href="shop-single-left.html">
                                        <img class="img-responsive" src="zassets/images/demo/shop/home/products/4.jpg" alt="" />
                                    </a>
                                    <!-- /product image(s) -->
                        ...
                        <li class="col-lg-2 col-sm-4">
                            ...
                            <div class="shop-item">
                                ...
                                <div class="thumbnail noborder nopadding">
                                    <!-- product image(s) -->
                                    <a class="shop-item-image" href="shop-single-left.html">
                                        <img class="img-responsive" src="zassets/images/demo/shop/home/products/0.jpg" alt="" />
                                    </a>
                                    <!-- /product image(s) -->
                ...
                <div class="container">
                    ...
                    <div class="text-center">
                        <div class="owl-carousel nomargin" data-plugin-options='{"singleItem": false, "autoPlay": 3000}'>
                            <div>
                                <img class="img-responsive" src="zassets/images/demo/brands/1.jpg" alt="">
                            </div>
                            <div>
                                <img class="img-responsive" src="zassets/images/demo/brands/2.jpg" alt="">
                            </div>
                            <div>
                                <img class="img-responsive" src="zassets/images/demo/brands/3.jpg" alt="">
                            </div>
                            <div>
                                <img class="img-responsive" src="zassets/images/demo/brands/4.jpg" alt="">
                            </div>
                            <div>
                                <img class="img-responsive" src="zassets/images/demo/brands/5.jpg" alt="">
                            </div>
                            <div>
                                <img class="img-responsive" src="zassets/images/demo/brands/6.jpg" alt="">
                            </div>
                            <div>
                                <img class="img-responsive" src="zassets/images/demo/brands/7.jpg" alt="">
                            </div>
                            <div>
                                <img class="img-responsive" src="zassets/images/demo/brands/8.jpg" alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row margin-top-60 margin-bottom-40 size-13">
                        ...
                        <div class="col-md-4 col-sm-4">
                            ...
                            <!-- Footer Logo -->
                            <img class="footer-logo" src="zassets/images/logo-footer.png" alt="" />
                        ...
                        <div class="col-md-8 col-sm-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <p>	<!-- see zassets/images/cc/ for more icons -->
                                        <img src="zassets/images/cc/Visa.png" alt="" />
                                        <img src="zassets/images/cc/Mastercard.png" alt="" />
                                        <img src="zassets/images/cc/Maestro.png" alt="" />
                                        <img src="zassets/images/cc/PayPal.png" alt="" />
                                    </p>
                                </div>
            ...
            <div id="shopLoadModal" class="modal fade" data-autoload="true" data-autoload-delay="2000">
                <div class="modal-dialog modal-full">
                    <div class="modal-content" style="background-image:url('zassets/images/misc/shop/shop_modal.jpg');">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="block-content">
                                ...
                                <img src="zassets/images/logo-footer-dark.png" alt="" />
        ...
        <!-- JAVASCRIPT FILES -->
        <script type="text/javascript">var plugin_path = 'zassets/plugins/';</script>
        <?php $this->endBody() ?>
    </body>
</html>
<?php $this->endPage() ?>